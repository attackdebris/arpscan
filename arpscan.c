 ...
 *	Arpscan
 *
 *	Copyright (C) 2002-2007 Jan Bobrowski <jb@wizard.ae.krakow.pl>
 *
...
{
	for(;;) switch(getopt(argc, argv, "fsaepwlV?")) {
		...
		case '?':
			...
			return 0;
		case 'V':
			printf("Arpscan by Jan Bobrowski 2002-2007\n"
				"Version: " STR(VER) " (compiled: " __DATE__")\n"
				"License: GPL\n"
				"Homepage: wizard.ae.krakow.pl/~jb/arpscan/\n");
			return 0;
		case EOF:
			goto endopt;
	}
